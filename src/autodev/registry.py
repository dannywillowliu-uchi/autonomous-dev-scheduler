"""Central project registry at ~/.autodev/registry.db."""
...
DEFAULT_REGISTRY_DIR = Path.home() / ".autodev"
...
class ProjectRegistry:
	...
	Stores data in ~/.autodev/registry.db.
	"""
	...
	def register(
		...
		if not db_path:
			db_path = str(config.parent / "autodev.db")
