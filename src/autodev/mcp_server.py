"""MCP server for programmatic autodev from Claude Code."""
...
TOOLS = [
	...
	Tool(
		...
		inputSchema={
			"type": "object",
			"properties": {
				"config_path": {"type": "string", "description": "Absolute path to autodev.toml"},
...
def _search_duckduckgo(query: str) -> list[dict]:
	...
	req = urllib.request.Request(url, headers={"User-Agent": "autodev/1.0"})
...
def run_mcp_server() -> None:
	"""Entry point for `autodev mcp` CLI command."""
	import asyncio
