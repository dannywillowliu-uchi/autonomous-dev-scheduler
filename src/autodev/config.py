"""TOML configuration loader for autodev."""
...
class GreenBranchConfig:
	...
	working_branch: str = "autodev/working"
	green_branch: str = "autodev/green"
...
class ContainerConfig:
	...
	image: str = "autodev-worker:latest"
...
def build_claude_cmd(
	...
	*,
	...
	if resume_session:
		cmd: list[str] = [claude_bin, "--resume", resume_session, "-p", "--output-format", output_format]
	else:
...
def load_config(path: str | Path) -> MissionConfig:
	"""Load a autodev.toml config file.
