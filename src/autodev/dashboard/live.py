"""Live automatic development dashboard -- real-time WebSocket + REST API."""
...
from autodev.models import Signal, TrajectoryRating

logger = logging.getLogger(__name__)

_UI_PATH = importlib.resources.files("autodev.dashboard").joinpath("live_ui.html")
...
class LiveDashboard:
	"""Real-time automatic development dashboard.
	...
	def __init__(self, db_path: str, auth_token: str = "") -> None:
		...
		self.app = FastAPI(title="Automatic Development Live", lifespan=_lifespan)
	...
	def _setup_routes(self) -> None:
		...
		async def index() -> HTMLResponse:
			...
			return HTMLResponse("<h1>Automatic Development Live</h1><p>UI file not found.</p>")
